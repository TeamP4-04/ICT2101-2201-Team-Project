...
def logdetails(logID):
    ...
    cur=conn.cursor()
    cur.execute("select logID, commands, stageID, distance_travelled, rotation, obstacle_position, time_spent from Logs, CarInformation where logID = carInformationID and logID = ?", logID)
